...
class FTN_encoder(nn.Module):
    ...
    def __init__(self, img_size=512,  in_chans=3, embed_dim=512, token_dim=64):
        ...
        self.swt_1 = nn.Sequential(nn.Conv2d(token_dim,token_dim*2, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1)))
        self.swt_2 = nn.Sequential(nn.Conv2d(token_dim*2,token_dim*4, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1)))
