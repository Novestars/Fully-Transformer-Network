...
from train2 import get_trans
from classification import T2t_vit_12

def parse_args():
    parser = argparse.ArgumentParser()
    parser.add_argument('--kernel-type', type=str, default='vit12_32_768_12_4')
    parser.add_argument('--data-dir', type=str, default='/DATA_SSD/process_HXZ/sl/data/')
    parser.add_argument('--data-folder', type=int, default='512')
    parser.add_argument('--image-size', type=int, default='384')
    parser.add_argument('--enet-type', type=str, default='vit12')
    ...
    parser.add_argument('--model-dir', type=str, default='./weights/backupvit12')
...
if __name__ == '__main__':
    ...
    if args.enet_type == 'vit12':
        ModelClass = T2t_vit_12
    else:
